...
public class MyTweetRecyclerViewAdapter extends RecyclerView.Adapter<MyTweetRecyclerViewAdapter.ViewHolder> {
    ...
    @Override
    // 2 - Metodo que va a pintar cada elemento ed la lista en la vista a traves de su posicion
    public void onBindViewHolder(final ViewHolder holder, int position) {
        // Accedemos al elemento de la lista
        if(mValues!= null) {
            holder.mItem = mValues.get(position);

            // A traves del elemento, pintamos los datos
    ...
    // 1- modificamos el ViewHolder con cada elemento
